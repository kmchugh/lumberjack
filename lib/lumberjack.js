...
exports = module.exports = function lumberjack(options) {
    ...
    var logger = (function(){
        ...
        for (var logConfig in allConfigs)
        {
            ...
            loggerList[logConfig] = require('./loggers/' + logConfig)(merge(allConfigs[logConfig], config));
            loggerCount++;
        }
        ...
        return {
            ...
            get: function(/*[loggerType, ] property*/){
                return arguments.length === 1 ?
                    loggerList[firstLogger].config[arguments[0]] :
                    loggerList[arguments[0]].config[arguments[1]];
            },
            /**
